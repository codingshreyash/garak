...
def _load_reliability_probe() -> garak.probes.audio_reliability.TTSReliability:
    _config.load_config()
    return garak.probes.audio_reliability.TTSReliability()
...
def test_tts_reliability_cases_cover_symbol_boundaries():
    cases = garak.probes.audio_reliability.tts_reliability_cases()
...
def test_tts_reliability_records_case_metadata(monkeypatch, tmp_path):
    ...
    assert len(attempts) == len(garak.probes.audio_reliability.tts_reliability_cases())
